...
export default function Home() {
  return <main><SiteHeader />
    <section className="hero">
      <div className="hero-image"><img src="/media/wardrobe.png" alt="Custom dressing room by Vantage Interiors" /></div><div className="hero-shade" />
      <div className="hero-copy"><p className="eyebrow">Interior design · Bespoke joinery</p><h1>Spaces with<br /><em>presence.</em></h1><p className="hero-intro">Thoughtful interiors, beautifully made—from the first line drawn to the final detail placed.</p><div className="hero-actions"><a className="button cream-button" href={quoteUrl} target="_blank" rel="noreferrer">Request a quote <span>↗</span></a><Link className="hero-link" href="/projects">View our work <span>↓</span></Link></div></div>
    </section>

    <section className="video-feature"><video autoPlay muted loop playsInline poster="/media/home-office.png"><source src="/media/process.mp4" type="video/mp4" /></video><div className="video-overlay"><p>Designed for living</p><h2>See the detail.<br /><em>Feel the difference.</em></h2><Link href="/projects">Explore projects ↗</Link></div></section>
